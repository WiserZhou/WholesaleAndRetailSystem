...
public interface OrderMapper {
     ...
     * @return 结果
     */
    public List<Order> selectPostsByUserName(String userName);
     ...
     * @return 结果
     */
    public Order checkPostNameUnique(String postName);
     ...
     * @return 结果
     */
    public Order checkPostCodeUnique(String postCode);
}
