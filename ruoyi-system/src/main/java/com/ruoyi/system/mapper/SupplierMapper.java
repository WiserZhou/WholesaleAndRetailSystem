...
public interface SupplierMapper {
     ...
     * @return 结果
     */
    public List<Supplier> selectPostsByUserName(String userName);
     ...
     * @return 结果
     */
    public Supplier checkPostNameUnique(String postName);
     ...
     * @return 结果
     */
    public Supplier checkPostCodeUnique(String postCode);
}
