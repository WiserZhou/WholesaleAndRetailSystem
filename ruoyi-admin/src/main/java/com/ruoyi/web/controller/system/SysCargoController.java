 ...
 */
@RestController
@RequestMapping("/system/cargo")
public class SysCargoController extends BaseController
{
    @Autowired
    private ISysCargoService deptService;
    ...
    {
        List<SysCargo> depts = deptService.selectDeptList(dept);
    ...
    {
        List<SysCargo> depts = deptService.selectDeptList(new SysCargo());
